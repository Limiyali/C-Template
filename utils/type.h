...
template <typename T> void print_type(T obj) {
  cout << abi::__cxa_demangle(typeid(obj).name(),nullptr,nullptr,nullptr) << endl;
}

template <typename T>
struct print_full_type
{
    print_full_type(void)  { std::cout << abi::__cxa_demangle(typeid(T).name(),nullptr,nullptr,nullptr); }
